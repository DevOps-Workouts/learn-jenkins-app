pipeline {
    ...
    stages {
        ...
        stage('E2E') {
                ...
                post {
                    always {
                        publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', reportName: 'Playwright E2E Local Report', reportTitles: '', useWrapperFileDirectly: true])
                    }
                }
            }
        }
